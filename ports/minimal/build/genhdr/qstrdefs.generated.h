...
QDEF(MP_QSTR___iand__, (const byte*)"\xa7\x08" "__iand__")
QDEF(MP_QSTR___ifloordiv__, (const byte*)"\x4f\x0d" "__ifloordiv__")
QDEF(MP_QSTR___ilshift__, (const byte*)"\x80\x0b" "__ilshift__")
QDEF(MP_QSTR___imod__, (const byte*)"\x4a\x08" "__imod__")
QDEF(MP_QSTR___import__, (const byte*)"\x38\x0a" "__import__")
QDEF(MP_QSTR___imul__, (const byte*)"\x18\x08" "__imul__")
QDEF(MP_QSTR___init__, (const byte*)"\x5f\x08" "__init__")
QDEF(MP_QSTR___invert__, (const byte*)"\xf7\x0a" "__invert__")
QDEF(MP_QSTR___ior__, (const byte*)"\xf1\x07" "__ior__")
QDEF(MP_QSTR___ipow__, (const byte*)"\x84\x08" "__ipow__")
QDEF(MP_QSTR___irshift__, (const byte*)"\xde\x0b" "__irshift__")
QDEF(MP_QSTR___isub__, (const byte*)"\x08\x08" "__isub__")
QDEF(MP_QSTR___iter__, (const byte*)"\xcf\x08" "__iter__")
QDEF(MP_QSTR___itruediv__, (const byte*)"\x21\x0c" "__itruediv__")
QDEF(MP_QSTR___ixor__, (const byte*)"\x09\x08" "__ixor__")
...
QDEF(MP_QSTR___sizeof__, (const byte*)"\x09\x0a" "__sizeof__")
...
QDEF(MP_QSTR_getsizeof, (const byte*)"\xff\x09" "getsizeof")
